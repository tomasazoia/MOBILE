...
import 'package:flutter/services.dart'; // Import necessário para o TextInputFormatter
...
class _RegisterGooglePageState extends State<RegisterGooglePage> {
  ...
  Future<void> _registerWithGoogle() async {
    ...
    if (_formKey.currentState?.validate() ?? false) {
      try {
        ...
        print('Erro ao registar com Google: $e');
        _showError('Erro ao registar com Google. Tente novamente.');
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Registar com Google'),
  ...
  Widget _buildTextField(
    ...
    TextInputType keyboardType =
        TextInputType.text, // Parâmetro keyboardType adicionado
  }) {
    return Padding(
      ...
      child: TextFormField(
        ...
        onChanged: onChanged,
        inputFormatters:
            inputFormatters, // Aplicando os formatadores de entrada
        keyboardType: keyboardType, // Aplicando o tipo de teclado
      ),
    );
  }
